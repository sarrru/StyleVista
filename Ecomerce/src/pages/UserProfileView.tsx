...
function UserProfileView(){
    ...
    return(
        <div style={{backgroundColor:"white",minWidth:250}} className={"user_profile_main"}>
            <div style={{backgroundColor:"red"}} className={"cross-icon"}>
            ...
            <div  className={"my_profile"}>
                ...
                <form  className={"user_profile_form"}>
                    ...
                    <div className={"order-history"}>
                        <button style={{backgroundColor:"pink",color:"black"}} className={"order-history-btn"}>Order History</button>
                        <button style={{backgroundColor:"pink",color:"black"}} className={"logout-btn"} onClick={handleLogout}>Sign out</button>
                    </div>
                </form>
            </div>
        </div>
