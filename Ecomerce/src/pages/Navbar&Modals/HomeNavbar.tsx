import logo from "../../images/Vstyle.png";
            ...
            <div className={"nav-bar"}>
                ...
                <div className={"home-options"}>
                    <ul>
                        ...
                        <Link to={"/Shop"}><li className={activePage === "/Shop" ? "active" : ""}><a>Shop</a></li></Link>

                        <Link to={"/ContactPage"}><li className={activePage === "/ContactPage" ? "active" : ""}><a>Contact us</a></li></Link>
                    </ul>
                </div>
